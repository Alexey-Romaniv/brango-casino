...
export default function Home() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://api.adkey-seo.com/api/website/get-website/294');
    ...
    return (
                <>
                    <Hero firstId={data?.offers[0].id} firstBonus={data?.offers[0].bonuses.welcome_bonus} />
